...
var HomeComponent = (function () {
    ...
    HomeComponent.prototype.filterVisits = function (searchString) {
        ...
        return this.visits.filter(function (visit) {
            return visit._camera._shop.branch.toLowerCase().indexOf(searchString.toLowerCase()) !== -1;
        });
    };
    ...
    HomeComponent.prototype.getVisits = function () {
        ...
        visitsObservable.subscribe(function (data) {
            ...
            console.log('this is the visit data: ', _this.visits);
    ...
    HomeComponent.prototype.getShops = function () {
        ...
        shopObservable.subscribe(function (data) {
            _this.shops = data;
            _this.shops.splice(0, 0, '');
            console.log('this is the shop data: ', _this.shops);
        });
    };
